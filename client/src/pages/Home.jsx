...
import { Send, ArrowUp, Plus, LayoutGrid, Menu, Phone, PhoneOff, Mic, MicOff, Volume2, Volume1, Video, VideoOff, Camera, RefreshCw, UserPlus, Check, X as CloseIcon, Users, Settings, Globe, Trash2, Download } from 'lucide-react';
...
const Home = () => {
  ...
  const VocabularyStudy = () => {
    const [activeTab, setActiveTab] = useState('dashboard'); // 'dashboard' | 'vocabulary' | 'grammar' | 'stats'
    ...
    return (
      <div className="flex-1 bg-[#121212] flex overflow-hidden animate-in fade-in duration-700">
        {/* LMS Sidebar */}
        <div className="w-64 shrink-0 bg-[#1a1a1a] border-r border-white/5 flex flex-col p-4 hidden lg:flex">
        ...
        <div className="flex-1 overflow-y-auto bg-[#121212]">
          {/* Header Mobile Only */}
          <div className="lg:hidden p-4 flex items-center justify-between border-b border-white/5 bg-[#1a1a1a]">
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 rounded-3xl text-white shadow-2xl shadow-blue-600/20">
                    <h3 className="text-blue-100 text-xs font-bold uppercase mb-4">Streak</h3>
                  ...
                  <div className="bg-[#1a1a1a] p-6 rounded-3xl border border-white/5 shadow-xl">
                    <h3 className="text-gray-500 text-xs font-bold uppercase mb-4">Level</h3>
                  ...
                  <div className="bg-[#1a1a1a] p-6 rounded-3xl border border-white/5 shadow-xl sm:col-span-2 lg:col-span-1">
                    <h3 className="text-gray-500 text-xs font-bold uppercase mb-4">Next Lesson</h3>
                ...
                <div className="bg-[#1a1a1a] rounded-3xl border border-white/5 overflow-hidden">
                  <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                    <h3 className="text-sm font-bold text-white">Recommended Readings</h3>
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-[#1a1a1a] p-8 rounded-[40px] border border-white/5 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Word of the Day</span>
                    </div>
                    ...
                    {stealthWord ? (
                          ...
                          {stealthWord.meanings[0].definitions[0].example && (
                            <div className="bg-white/5 p-4 rounded-2xl border-l-4 border-blue-500">
                              <p className="text-gray-400 text-sm">
                                <span className="font-bold text-white mr-2">Usage:</span> 
                                {stealthWord.meanings[0].definitions[0].example}
                              </p>
                            </div>
                          )}
                      ...
                      <div className="h-48 flex items-center justify-center text-gray-500 animate-pulse font-medium italic">
                        Connecting to dictionary server...
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-[#1a1a1a] p-4 rounded-2xl border border-white/5 flex items-center gap-3">
                    <div className="w-8 h-8 bg-green-500/20 text-green-500 rounded-lg flex items-center justify-center text-[10px] font-bold">Syn</div>
                    <span className="text-xs text-gray-400">Expand your expression range</span>
                  </div>
                  <div className="bg-[#1a1a1a] p-4 rounded-2xl border border-white/5 flex items-center gap-3">
                    <div className="w-8 h-8 bg-purple-500/20 text-purple-500 rounded-lg flex items-center justify-center text-[10px] font-bold">Ctx</div>
                    <span className="text-xs text-gray-400">Contextual usage analysis</span>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="bg-[#1a1a1a] p-8 rounded-[40px] border border-white/5 shadow-2xl">
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      <h2 className="text-2xl font-black text-white">Grammar Lab</h2>
                      <p className="text-gray-500 text-sm">Submit your sentences for structural analysis</p>
                    </div>
                    {isAnalyzing && (
                      <div className="flex items-center gap-2 text-blue-500">
                        <div className="w-2 h-2 rounded-full bg-blue-500 animate-ping" />
                        <span className="text-[10px] font-bold uppercase">AI Analysis...</span>
                      </div>
                    )}
                  </div>
                  ...
                  <textarea 
                    ...
                    placeholder="Type a sentence here (e.g., 'If I were you, I would study harder.')"
                ...
                <div className="bg-blue-500/5 border border-blue-500/20 p-6 rounded-3xl">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs font-bold text-blue-500 uppercase tracking-widest">Expert Tip</span>
                  </div>
                  <p className="text-sm text-gray-300 leading-relaxed">
                    Always pay attention to the **subject-verb agreement** when writing complex sentences with multiple clauses.
                  </p>
                </div>
              </div>
            )}
                ...
                <div className="bg-[#1a1a1a] rounded-[40px] border border-white/5 overflow-hidden shadow-2xl">
                  ...
                  <div className="divide-y divide-white/5">
                    {[
                      ...
                      <div key={i} className={`flex items-center gap-4 p-6 ${user.isMe ? 'bg-blue-600/10' : ''}`}>
                        <span className="w-6 text-gray-500 font-bold">#{i + 1}</span>
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${user.isMe ? 'bg-blue-600 text-white' : 'bg-white/5 text-gray-400'}`}>
                          {user.name[0]}
                        </div>
                        <div className="flex-1">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">XP Points</p>
                        </div>
                      </div>
                    ))}
                  </div>
