...
const Sidebar = ({ status, onNewChat, onEndSession, userCount, isOpen, onClose, onStartCall, isCalling, callAccepted, friends = [], onSelectFriend, onRemoveFriend, onInform }) => {
  ...
  return (
    <>
      ...
      <div className={`
        fixed inset-y-0 left-0 z-[70] w-[280px] bg-[#171717] flex flex-col border-r border-[#2f2f2f] 
      ...
      <div className="p-4 border-t border-[#2f2f2f] space-y-2 bg-[#1a1a1a]/50">
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            ...
            <span className="text-[13px] text-gray-400 group-hover:text-gray-200">Submit Feedback</span>
          </div>
